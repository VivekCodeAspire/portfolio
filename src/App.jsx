...
function App() {
  ...
  //  const size =  lg:mt-36 sm:mt-14 mt-24

  return (
    <div className="w-screen h-screen bg-custom bg-cover bg-center bg-fixed bg-no-repeat  overflow-hidden ">
      {/* main container */}
      <div className=' w-full h-full m-auto flex flex-col gap-5 items-center  justify-center'>
        {/* profile image*/}
